 ...
 */
class ServiceDiabetes extends \DiabeteBundle\Entity\ServiceDiabetes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DiabeteBundle\\Entity\\ServiceDiabetes' . "\0" . 'glucometer', 'id', 'createdAt', 'closedAt', 'isActive', 'subscriber');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServiceDiabetes $proxy) {
    ...
    public function setGlucometer(\DiabeteBundle\Entity\Glucometer $glucometer = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGlucometer', array($glucometer));

        return parent::setGlucometer($glucometer);
    }
    ...
    public function getGlucometer()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGlucometer', array());

        return parent::getGlucometer();
    }
