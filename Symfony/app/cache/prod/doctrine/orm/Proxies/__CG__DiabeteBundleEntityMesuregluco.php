 ...
 */
class Mesuregluco extends \DiabeteBundle\Entity\Mesuregluco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DiabeteBundle\\Entity\\Mesuregluco' . "\0" . 'id', '' . "\0" . 'DiabeteBundle\\Entity\\Mesuregluco' . "\0" . 'idAbonne', '' . "\0" . 'DiabeteBundle\\Entity\\Mesuregluco' . "\0" . 'date', '' . "\0" . 'DiabeteBundle\\Entity\\Mesuregluco' . "\0" . 'valeur', '' . "\0" . 'DiabeteBundle\\Entity\\Mesuregluco' . "\0" . 'temperature', '' . "\0" . 'DiabeteBundle\\Entity\\Mesuregluco' . "\0" . 'raison');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Mesuregluco $proxy) {
