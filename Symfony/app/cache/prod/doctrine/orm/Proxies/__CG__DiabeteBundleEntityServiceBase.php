 ...
 */
class ServiceBase extends \DiabeteBundle\Entity\ServiceBase implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'createdAt', 'closedAt', 'isActive', 'subscriber');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServiceBase $proxy) {
