...
/* DiabeteBundle:Subscriber:nutrition.html.twig */
class __TwigTemplate_8303a7139442117263c455edcb6d507e4b9ec4fbe7e4050f34051943114d224c extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["nbDays"]) {
            ...
            echo " value=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("nutrition", array("nbDaysAgo" => $context["nbDays"])), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return "DiabeteBundle:Subscriber:nutrition.html.twig";
    }
