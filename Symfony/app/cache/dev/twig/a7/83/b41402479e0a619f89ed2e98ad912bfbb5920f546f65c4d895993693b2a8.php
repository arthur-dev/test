...
/* DiabeteBundle:Doctor:nutrition.html.twig */
class __TwigTemplate_a783b41402479e0a619f89ed2e98ad912bfbb5920f546f65c4d895993693b2a8 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["nbDays"]) {
            ...
            echo " value=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("doctorViewNutrition", array("id" => $this->getAttribute($this->getContext($context, "subscriber"), "id", array()), "nbDaysAgo" => $context["nbDays"])), "html", null, true);
            echo "\">";
...
\t\t\t\t\t\t";
        // line 29
        if (($this->getContext($context, "nutritionData") != "[]")) {
            // line 30
            echo "\t\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t\t<div class=\"col-md-12\">
\t\t\t\t\t\t\t\t\t<div id=\"chart-nutrition\" data-nutritiondata=\"";
            // line 32
            echo twig_escape_filter($this->env, $this->getContext($context, "nutritionData"), "html", null, true);
            echo "\"></div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t";
...
\t<script type=\"text/javascript\" src=\"";
            // line 59
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/Diabete/js/modules/highcharts-nutrition.js"), "html", null, true);
            echo "\"></script>
";
        }
        // line 61
...
";
    ...
    {
        return "DiabeteBundle:Doctor:nutrition.html.twig";
    }
