...
/* DiabeteBundle:Doctor:insuline.html.twig */
class __TwigTemplate_7a094278e956a9a76bbf29ad1551e0c8c5afcd84dcdb225fa18be7e78300ac42 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["nbDays"]) {
            ...
            echo " value=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("doctorViewInsuline", array("id" => $this->getAttribute($this->getContext($context, "subscriber"), "id", array()), "nbDaysAgo" => $context["nbDays"])), "html", null, true);
            echo "\">";
...
\t\t\t\t\t\t";
        // line 29
        if (($this->getContext($context, "insulinData") != "[]")) {
            // line 30
            echo "\t\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t\t<div class=\"col-md-12\">
\t\t\t\t\t\t\t\t\t<div id=\"chart-insulin\" data-insulindata=\"";
            // line 32
            echo twig_escape_filter($this->env, $this->getContext($context, "insulinData"), "html", null, true);
            echo "\"></div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t";
...
\t<script type=\"text/javascript\" src=\"";
            // line 59
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/Diabete/js/modules/highcharts-insulin.js"), "html", null, true);
            echo "\"></script>
";
        }
        // line 61
...
";
    ...
    {
        return "DiabeteBundle:Doctor:insuline.html.twig";
    }
