...
/* DiabeteBundle:Subscriber:insuline.html.twig */
class __TwigTemplate_8f4eb7331feb573c110e8206e3dedc2addd953d4ca8c8735392a221949224ec8 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["nbDays"]) {
            ...
            echo " value=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("insuline", array("nbDaysAgo" => $context["nbDays"])), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return "DiabeteBundle:Subscriber:insuline.html.twig";
    }
